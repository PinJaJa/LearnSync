export default function Home() {
  return (
    <main id="main-content" className="flex min-h-screen flex-col items-center justify-between p-24" role="main">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm">
        <h1 className="text-4xl font-bold mb-8" tabIndex="0">Welcome to LearnSync</h1>
        <p className="text-xl mb-4" tabIndex="0">An innovative educational platform that combines AI-powered learning tools with collaborative features.</p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12" role="list" aria-label="Features">
          <FeatureCard
            title="AI Tutor"
...
function FeatureCard({ title, description }) {
  return (
    <article className="p-6 border rounded-lg shadow-md hover:shadow-lg transition-shadow" role="listitem" tabIndex="0">
